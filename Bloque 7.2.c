...
int main(){
	...
	vector = (int*)malloc(N*sizeof(int)); // Para crear un vector dinamico se pone un puntero (*) menos y el nombre del vector
	// la sentencia anterior le asigna un tamaño al vector de manera dinamica
	// int = 2 bite - por tanto vector tendra un tamaño de de 20 bite
	if(vector == NULL){
